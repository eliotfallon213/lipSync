(function(exports) {
    ...
    function embedVideoPreview(opt_url) {
        ...
        if (!video) {
            ...
            //Commented to allow external control
            //video.autoplay = true;
            //video.controls = false;
            //video.loop = false;
    ...
    function initEvents() {
        ...
        $('.play').addEventListener('click', playBoth);
        $('.pause').addEventListener('click', pauseBoth);
    }
